...
const petitionExport = {
  abonos: async (query, fieldsToShow) => {
    let populateOptions = [];
  ...
  truck: async (query,startIndex,limit) => {
    ...
    const {edges, pageInfo} = pagination.search(carts,startIndex, limit)
    return {
  ...
  carrito: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(cartsRelations,startIndex, limit)
    return {
  ...
  credito: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(creditRelations,startIndex, limit)
    return {
  ...
  dimensiones: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(dimensionsRelations,startIndex, limit)
    return {
  ...
  gastos: async (query,startIndex          = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(spentsRelations,startIndex, limit)
    return {
  ...
  historial: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(recordsRelations,startIndex, limit)
    return {
      totalCount: spents.length,
      edges,
      pageInfo,
  ...
  local: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(storeRelations,startIndex, limit)
    return {
  ...
  lotes: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(lotsRelations,startIndex, limit)
    return {
  ...
  metodopago: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(paymentMethodRelations,startIndex, limit)
    return {
  ...
  productos: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(ProductRelations,startIndex, limit)
    return {
  ...
  promociones: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(promotionsRelations,startIndex, limit)
    return {
  ...
  proveedor: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(providerRelations,startIndex, limit)
    return {
  ...
  rutas: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(routeRelations,startIndex, limit)
    return {
  ...
  usuarios: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(usersRelations,startIndex, limit)
    return {
  ...
  vendedores: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(sellersRelations,startIndex, limit)
    return {
  ...
  Ventas: async (query,startIndex = 0,limit = 20) => {
    ...
    const {edges, pageInfo} = pagination.search(salesRelations,startIndex, limit)
    return {
